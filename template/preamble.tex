%% Time-stamp: <2012-07-13 23:34:40 vk>
%%%% === Disclaimer: =======================================================
%% created by
%%
%%      Karl Voit
...
\usepackage[american]{babel}  %% used languages; default language is last language of options
%\usepackage[american,ngerman]{babel}  %% used languages; default language is last language of options
